				...
				<div class="alert alert-info bg-gradient-success text-white">
				  ...
				  <form class="form-inline">
		  			...
		  			<a href="<?php echo base_url('admin/dataAbsensi/cetakAbsensi?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-danger mb-2 ml-3"><i class="fas fa-print"></i> Cetak Daftar Absensi</a>
		  			<?php }else{ ?>
			  			<button type="button" class="btn btn-danger mb-2 ml-3" data-toggle="modal" data-target="#exampleModal">
			  			<i class="fas fa-print"></i> Cetak Daftar Absensi</button>
				<?php } ?>
					</form>
				  </div>
				</div>
