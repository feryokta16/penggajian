                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <?php foreach($lembur as $p) : ?>
                            <form method="POST" action="<?php echo base_url('admin/presensipulang/UpdateDataAksi')?>" enctype="multipart/form-data">
                        <div class="card-body" style="width: 60%; margin-bottom: 100px;">
                            <div class="form-group">
                                <label>Nik</label>
                                <input type="hidden" name="id_presensi_pulang" class="form-control" readonly value="<?php echo $p->id_presensi_pulang ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="deskripsi"  class="form-control" value="<?php echo $p->deskripsi ?>" readonly>
                                <?php echo form_error('status','<div class="text-small text-danger"></div>')?>
                            </div>
