                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="width: 60%; margin-bottom: 100px;">
                            <form method="POST" action="<?php echo base_url('admin/inputlembur/tambahDataAksi')?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="laporan_lembur" placeholder="Masukan Laporan Lembur" class="form-control">
                                <?php echo form_error('status','<div class="text-small text-danger"></div>')?>
                            </div>
                            <div class="form-group">
                                <label>Photo</label>
