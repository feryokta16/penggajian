                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="width: 60%; margin-bottom: 100px;">
                            <form method="POST" action="<?php echo base_url('pegawai/presensipulang/tambahDataAksi')?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jam_pulang" value= " <?= date('H:i:s');?>" class="form-control" readonly>
                                <?php echo form_error('nama_pegawai','<div class="text-small text-danger"></div>')?>
                            </div>
                            <div class="form-group">
                                <label>Jabatan</label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="deskripsi" placeholder="kegiatan selama melakukan pekerjaan">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                ...
                                <option value="Lembur">Mengajukan Lembur</option>
                                </select>
