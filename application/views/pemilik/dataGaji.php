                ...
                <div class="container-fluid" style="padding-bottom: 100px;">
				  ...
				  <form class="form-inline">
					  ...
					  <!--<a href="<?php echo base_url('admin/dataPenggajian/inputAbsensi') ?>" class="btn btn-success mb-2 ml-2"><i class="fas fa-plus">Input Data Kehadiran</i></a>-->
					  <?php 
					  ...
					  ?>
					  <?php if(count($gaji) > 0 ) { ?>
		  			<!--<a href="<?php echo base_url('admin/dataPenggajian/cetakGaji?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-danger mb-2 ml-3"><i class="fas fa-print"></i> Cetak Daftar Gaji</a>-->
		  			<?php }else{ ?>
