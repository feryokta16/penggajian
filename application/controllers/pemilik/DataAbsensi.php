...
class DataAbsensi extends CI_Controller{
    ...
    public function index(){
        ...
        $data['absensi'] = $this->db->query("SELECT data_kehadiran.*,data_pegawai.nama_pegawai,data_pegawai.jenis_kelamin,data_pegawai.jabatan,data_pegawai.status
            from data_kehadiran
        ...
        $this->load->view('pemilik/dataAbsensi',$data);
        ...
        $data['input_absensi'] = $this->db->query("SELECT * from data_pegawai
            WHERE data_pegawai.status='Aktif' and NOT EXISTS (SELECT * FROM data_kehadiran WHERE bulan = '$bulantahun' AND data_pegawai.nik= data_kehadiran.nik) ORDER BY data_pegawai.nama_pegawai ASC")->result();
    ...
    public function cetakAbsensi(){
        ...
        $data['cetakAbsensi'] = $this->db->query("SELECT data_kehadiran.*,data_pegawai.nama_pegawai,data_pegawai.jenis_kelamin,data_pegawai.jabatan
            from data_kehadiran
            INNER JOIN data_pegawai ON data_kehadiran.nik= data_pegawai.nik
            ...
            ORDER BY data_pegawai.nama_pegawai ASC")->result();
        $this->load->view('templates_admin/header',$data);
        $this->load->view('admin/cetakDataAbsensi');
    }
}
?>